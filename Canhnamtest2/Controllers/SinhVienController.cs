...
using Canhnamtest2.Models.ViewModels;
using Canhnamtest2.Models.Process;
using System.Data;
using X.PagedList;
using OfficeOpenXml;
namespace Canhnamtest2.Controllers
{
    public class SinhVienController : Controller
    {
        ...
        public async Task<IActionResult> Index(int? page, int? PageSize){
            ...
            int pagesize = (PageSize ?? 6); //Tao gia tri trong bang
            ViewBag.psize = pagesize;
            var model = _context.SinhVien.ToList().ToPagedList(page ?? 1, pagesize); //bat dau bang tu trang
            return View(model);
        }
...
//GET Index2 
        ...
        public  IActionResult Download(){
            var FileName ="NguyenCanhNam" +".xlxs";
